...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../Css/areaemp.css">
 ...
 <form name="form" enctype="multipart/form-data" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
    ...
    <script type="text/javascript">
        ...
        while($i = mysqli_fetch_array($pesquisa)){
          ...
          echo "<form name='user' action='../../Perfil/php/perfilemp.php' method=POST>"; 
          echo "<input name='codx' id='codx' type='hidden' value='".$i[0]."'> <br>";
         
          echo "<href='javascript:void(0)' onclick='this.parentNode.submit();'><div class='card'>";
          echo "<div class='cardimg'>";
          echo "<img class='fotos' src=../../FotosEmp/$i[6] width=200 heigth=200> <br>";
          echo "<a style='color:white;'class='nomein'>$i[2]</a> ";
          echo "</div>";

          echo "<div class='card_body'>";
          echo "<h6 class='card_title'>$i[2]</h6>";
      //    echo "<p class='card_text '>$i[3]</p>";
          echo "</div>";
          echo "</div>";
          echo "</form>";
          echo "</td>";
