...
echo "<div class='container'>";
    ...
    echo "<form name=fox action=../../Perfil/php/perfilemp.php  method=POST>"; 
  ...
  echo "<href='javascript:void(0)' onclick='this.parentNode.submit();'><div class='card'>";
          ...
          echo "<img class='fotos' src=../../FotosEmp/$registro[5] width=200 heigth=200 ><br>";
          echo "<a style='color:white;'class='nomein'>$registro[1]</a> ";
          echo "</div>";

          echo "<div class='card_body'>";
          echo "<h6 class='card_title'>$registro[2]</h6>";
          //echo "<p class='card_text '>$registro[3]</p>";
          echo "</div>";
          echo "</div>";
    echo "</form>";
